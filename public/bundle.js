...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Saved = __webpack_require__(254);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Search = function (_Component) {
		...
		_createClass(Search, [{
			key: "setSearch",
			value: function setSearch(text, startYear, endYear) {
				this.setState({
					searchTerm: text,
					startYear: startYear,
					endYear: endYear
			...
			value: function componentDidUpdate() {
				...
				_helpers2.default.runQuery(this.state.searchTerm, this.state.startYear, this.state.endYear).then(function (data) {
					return _this2.setState({ searchResults: data });
				});
			...
			value: function render() {
				return _react2.default.createElement(
					"div",
					{ className: "container col-sm-10" },
					_react2.default.createElement(_Form2.default, { setSearch: this.setSearch }),
					_react2.default.createElement(_Results2.default, { searchResults: this.state.searchResults })
				);
			}
		}]);
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement("input", { type: "text", className: "form-control text-left", name: "searchTerm", value: this.state.searchTerm, onChange: this.handleChange, required: true }),
								_react2.default.createElement(
									"h4",
									null,
									_react2.default.createElement(
								...
								_react2.default.createElement("input", { type: "text", className: "form-control text-left", name: "startYear", value: this.state.startYear, onChange: this.handleChange, required: true }),
								_react2.default.createElement(
									"h4",
									null,
									_react2.default.createElement(
								...
								_react2.default.createElement("input", { type: "text", className: "form-control text-left", name: "endYear", value: this.state.endYear, onChange: this.handleChange, required: true }),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
		runQuery: function runQuery(searchTerm, startYear, endYear) {
			var URL = "https://api.nytimes.com/svc/search/v2/articlesearch.json?q=" + searchTerm + "&sort=newest&begin_date=" + startYear + "0101&end_date=" + endYear + "0101&api-key=" + key;
			return axios.get(URL).then(function (res) {
				return res.data.response.docs;
			});
		},

		getArticles: function getArticles(x) {
		...
		saveArticle: function saveArticle(article) {
			return axios.post("/api", article).then(function (res) {
				return res;
			});
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Saved = function (_Component) {
		...
		_createClass(Saved, [{
			...
			key: "render",
			value: function render() {
				var results = this.state.savedArticles;
				var listResults = results.map(function (doc, i) {
					return _react2.default.createElement(
						"li",
						{ className: "list-group-item", key: i },
